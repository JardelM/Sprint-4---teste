...
import br.com.alura.forum.form.TesteForm;
...
public class AssociadoController {
	...
	public void vincular(@RequestBody TesteForm form) {
		
		
		//Associado associado = form.converter();
		
		//associadoRepository.save(form);
	...
	// FALTA TRATAR ERROS DO ENDPOINT post e put, MOSTRANDO O QUE FALTA SER
	// INSERIDO, e esses endpoints:

	// GET - /associados (Ter uma opção de filtrar associados de acordo com seu
	// cargo político e outra de ordenar por nome)
	@GetMapping()
