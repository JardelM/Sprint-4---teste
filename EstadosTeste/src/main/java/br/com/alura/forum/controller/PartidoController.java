...
public class PartidoController {
	...
	// E TBM TEM QUE TRATAR OS ERROS DESSES ENDPOINTS
	// E TBM VER COMO AJUSTAR ESSAS DATAS
	

	// POST - /partidos
	@PostMapping
	public ResponseEntity<PartidoDTO> cadastrar(@RequestBody PartidoForm form, UriComponentsBuilder uriBuilder) {
	...
	// GET - /partidos (Ter uma opção de filtrar partidos de acordo com sua
	// ideologia)
	@GetMapping()
